...
import { login } from '../../server/CustomerServer';
...
const Login = () => {
    ...
    const check = async (data) => {
        const message = {}
        if (!data.email) {
            message.usersName = "email is required"
            // return
        }
        if (!data.pass) {
    ...
    const handleLogin = async () => {
        ...
        if (!a.data) {
            ...
            localStorage.setItem("customer", JSON.stringify(a.data))
            console.log("Second", a.data)
